...
const ArrivalPage = ({ navigate, onMicroStart }) => (
  <div className="min-h-screen flex flex-col items-center justify-center p-6 md:p-8 bg-[#F8F7F2] relative overflow-hidden select-none text-center pt-28">
    ...
    <div className="text-center max-w-3xl z-10 space-y-10 md:space-y-14">
      <div className="animate-slow-fade opacity-0 text-center"><p className="text-xs md:text-sm tracking-[0.4em] text-[#8C7A66] font-black uppercase">信任圈 · 一起独处</p></div>
      ...
      <div className="animate-slow-fade delay-2s max-w-md mx-auto text-center px-4"><p className="text-[#4A4A48] text-base md:text-x1 font-serif leading-loose tracking-wider font-black text-center">这里是一处数字化的小院<br/>邀请你慢一点<br/>听见自己 也学习如何听见他人</p></div>
